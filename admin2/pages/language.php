...
if(isset($_POST["submit"])){
    ...
    $insert = "INSERT INTO `languages`(`languages`) VALUES ('$language')";

    $result = mysqli_query($conn, $insert);
if($result){
    echo "<script> location.href='language.php'; </script>";
    exit;}
...
<div class="main-panel">
    ...
    <div style="display: flex; justify-content: center; align-items: center;">
      <a href="#">
        <button type="button" style="width: 250px;" class="btn bg-dark btn-lg" data-bs-toggle="modal" data-bs-target="#exampleModal">Add a new Language</button>
      </a>
    </div>
                ...
                <table class="table align-items-center mb-0">
                  ...
                  <?php $i = 1;
                    ...
                    <tr>
                      ...
                      <a href="updatelanguage.php?id=<?php echo $row["id"] ?>">
                        ...
                        <a href="deletelanguage.php?id=<?php echo $row["id"] ?>">
                            <li class="list-inline-item">
    ...
    <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                ...
                <div class="row">
                    <h3 class="mb-4">Language</h3>
                    <div class="col">
                        <input style="border: 0.01px solid black;" type="text" class="form-control text-secondary" required name="language">
